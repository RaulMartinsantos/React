...
function PhotoWidget({ photo, loading }: PhotoWidgetProps) {
  return (
    <div className="flex flex-col gap-4">
      {!loading ? (
        <ImagePreview
          ...
          title={photo.title}
          imageClassNamePreview="w-[13.562rem] h-[10.875rem] rounded-lg"
        />
      ) : (
        <Skeleton className="w-[13.562rem] h-[10.875rem] rounded-lg" />
      )}
